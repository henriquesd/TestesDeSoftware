...
namespace Demo.Tests
{
    public class AssertingCollectionsTests
    {
        ...
        {
            // Arrange & Act
            var funcionario = FuncionarioFactory.Criar("Henrique", 10000);
        ...
        {
            // Arrange & Act
            var funcionario = FuncionarioFactory.Criar("Henrique", 1000);
        ...
        {
            // Arrange & Act
            var funcionario = FuncionarioFactory.Criar("Henrique", 15000);
